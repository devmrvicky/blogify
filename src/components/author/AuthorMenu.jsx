...
const AuthorMenu = () => {
  ...
  return (
    <div
      ...
      onClick={hideMenus}
    >
      <div className="border p-2 bg-white shadow-md flex flex-col rounded gap-2 absolute top-14 w-80 right-2 z-30">
        <h2 className="text-center text-xl font-semibold py-3 text-blue-800">
          {!status ? (
            <>
              Get started with
                    ...
                    !status
                      ? ({ isActive }) =>
                          isActive
                            ...
                            : "px-4 py-2 hover:bg-zinc-100 w-full cursor-pointer border border-blue-800 rounded-full font-semibold text-blue-800"
                      : ({ isActive }) =>
                          isActive
